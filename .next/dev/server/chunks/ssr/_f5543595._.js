module.exports = [
"[project]/lib/gameTypes.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gameTypes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/gameTypes.ts [app-ssr] (ecmascript)");
...
function isCorrectGuess(game, rawGuess) {
    const g = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gameTypes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["normalizeAnswer"])(rawGuess);
    if (!g) return false;
    const ok = new Set([
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gameTypes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["normalizeAnswer"])(game.title),
        ...(game.acceptableAnswers ?? []).map(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gameTypes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["normalizeAnswer"])
    ]);
    return ok.has(g);
}
...
"[project]/components/PlayerStatistics/index.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PlayerStatistics({ namespace }) {
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        const bestWin = finished.filter((s)=>s.status === "won").map((s)=>s.guesses.length).sort((a, b)=>a - b)[0];
        const sorted = [
            ...finished
        ].sort((a, b)=>a.puzzleKey.localeCompare(b.puzzleKey));
...
//# sourceMappingURL=_f5543595._.js.map